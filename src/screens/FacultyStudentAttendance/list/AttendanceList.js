...
const AttedanceListView = ({
  ...
  data={filteredStudentList}
  renderItem={({ item }) => (
    <Pressable style={styles.cardMain} key={item?.RollNo}>
      <View style={styles.cardheader}>
        <View style={styles.cardTop}>
          <Text
            style={[
              styles.studentCardHeading,
              {
                color: item?.Present ? colors.black : colors.red,
              },
            ]}
          >
            {item?.Name}
          </Text>
          <View style={styles.markAttView}>
            <CheckBox
              style={styles.checkbox}
              boxType="square"
              value={item?.Present === 1}
        ...
        <View style={styles.cardTop}>
          <Text
            style={[
              styles.studentCardHeading,
              {
                color: item?.Present ? colors.green : colors.red, // Updated color based on Present/Absent
              },
            ]}
          >
            {item?.Name}
          ...
          <View style={styles.markAttView}>
            ...
            <Text
              style={[
                ...
                { marginLeft: halfIndent },
                {
                  color: item?.Present ? colors.darkGreen : colors.red, // Updated color based on Present/Absent
